			...
			<div class="hero_content main-container">
				<div class="hero_content--bg-video">
					<video class="bg-video_content" autoplay muted >
						...
						<source src="http://krnjevac.rs/wp-content/themes/FoundationPress/src/assets/images/krnjevac.mp4" type="video/mp4">
					</video>
				</div>
				...
				<div class="hero_content--text">
					...
					<a class="button hero_content--button" type="button" href="?page_id=55">Krnjevac proizvodi <i class="fas fa-arrow-right"></i> </a>
				</div>
			</div>
		</div>
