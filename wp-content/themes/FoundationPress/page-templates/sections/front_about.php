<div class="section <?php echo($class);?>">
	<div class="section_about--text">
		...
		<div class="text-content">
			<?php the_content(); ?>
			<a href="?page_id=102" class="more-link-odd">Kontrola kvaliteta<i class="fas fa-arrow-right"></i></a>
			<a href="?page_id=102" class="more-link-even">Više o Krnjevac medu<i class="fas fa-arrow-right"></i></a>
		</div>
	</div>
