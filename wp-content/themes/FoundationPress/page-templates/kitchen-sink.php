            ...
            <div id="components" class="kitchen-sink-components">
                <article <?php post_class() ?> id="post-<?php the_ID(); ?>">
                    ...
                    <h2 id="button" class="docs-heading" data-magellan-target="button"><a href="#button"></a>Button</h2>
                        ...
                        <br />
                        <button class="button " type="button">Internet prodavnica</button>
                        <button class="button btn-grey" type="button">Pretrazi lokacije</button>
                        <button class="button btn-green" type="button">Postani partner</button>
                    <hr>
                    ...
                    <!-- Cards -->
                    <h2 id="cards" class="docs-heading" data-magellan-target="cards"><a href="#cards"></a>krnjevac</h2>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-content_description">
                                    ...
                                    <h3 class="card-content_description--price">579,-</h3>
                                </div>
                                <button class="button add-to-cart" type="button"><h3>+</h3></button>
                                <div class="card-content_image">
                    ...
                    <!-- krnjevac -- wtb -->
                    <div class="wtb grid-x">
                        <!-- <div class="wtb_links cell medium-3">
                            <a href="#">maxi</a>
                            <a href="#">dis</a>
                            <a href="#">roda</a>
                            <a href="#">tempo</a>
                        ...
                        <div class="wtb_text-area cell medium-5">
                            <h1>Gde kupiti?</h1>
                            <h3>Pored naše internet prodavnice, dostupni smo i u svim većim lancima supermarketa</h3>
                            <button class="button btn-grey" type="button">Pretrazi lokacije</button>
                        </div>

                        <!-- <div class="wtb_faq cell medium-4">
                            <div class="wtb_faq--section"></div>
                            <div class="wtb_faq--section"></div>
                            <div class="wtb_faq--section"></div>
                            <div class="wtb_faq--section"></div>
                        </div> -->
